Hooks:Add("NetworkManagerOnPeerAdded", "NetworkManagerOnPeerAdded_DW", function(peer, peer_id)
	if Network:is_server() then
		DelayedCalls:Add("DelayedWarnModBB" .. tostring(peer_id), 2, function()
			local message = "This is Hardcore lobby, a custom difficulty made for all hardcore heisters out there! It's suggested for everyone to have the mod installed to get the best experience. Enjoy the game!(V.3.8.3)"
